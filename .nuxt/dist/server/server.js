...
/******/ 			var chunk = require("./" + ({"1":"components/nuxt-logo","2":"components/tutorial","3":"pages/index","4":"pages/slice-simulator"}[chunkId]||chunkId) + ".js");
...
var PrismicDom = __webpack_require__(2);
...
var __PRODUCTION__ = "production" === "production";
...
const NuxtLogo = () => __webpack_require__.e(/* import() | components/nuxt-logo */ 1).then(__webpack_require__.bind(null, 39)).then(c => wrapFunctional(c.default || c));
const Tutorial = () => __webpack_require__.e(/* import() | components/tutorial */ 2).then(__webpack_require__.bind(null, 38)).then(c => wrapFunctional(c.default || c));
...
/* harmony default export */ var html_serializer = (null);
...
/* harmony default export */ var plugins_prismic = (async (context, inject) => {
  ...
  let api = {};
  try {
    api = client_default.a.client('https://amtweb.cdn.prismic.io/api/v2', Object.assign({}, options, {}));
  } catch (error) {
    console.error(error);
  ...
  let prismic = new external_vue_default.a({
    computed: {
      ...
      apiEndpoint() {
        return 'https://amtweb.cdn.prismic.io/api/v2';
      },
      predicate() {
        return client_default.a.Predicates;
      },
      predicates() {
        return client_default.a.Predicates;
      },
...
module.exports = require("@slicemachine/adapter-nuxt2/dist/simulator.cjs");
